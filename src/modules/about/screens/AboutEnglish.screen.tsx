      ...
      <Box>
        <Column gutter="lg">
          ...
          <Column gutter="sm">
            ...
            <Paragraph>
              The municipality often has maintenance on streets, quays, bridges
              and buildings. In 'Werkzaamheden' you can see the projects of your
              area. You can follow a project in the app. If you follow a
              project, you are always up to date with any activities.
            </Paragraph>
          </Column>
          <Column gutter="sm">
            ...
            <Paragraph>
              ...
              on the street? You can report all of that within the app. We will
              solve these problems for you as soon as possible.
            </Paragraph>
          </Column>
          <Image
