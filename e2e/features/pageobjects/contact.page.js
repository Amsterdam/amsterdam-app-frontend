...
class ContactPage extends Page {
    ...
    get ContactButtonCityOfficeCentrum() {
        return element(by.id('ContactButtonCityOfficee9871a7716da02a4c20cfb06f9547005'));
    }

    get ContactButtonCityOfficeNW() {
        return element(by.id('ContactButtonCityOffice5d9637689a8b902fa1a13acdf0006d26'));
    }

    get ContactButtonCityOfficeNoord() {
        return element(by.id('ContactButtonCityOffice081d6a38f46686905693fcd6087039f5'));
    }

    get ContactButtonCityOfficeOost() {
        return element(by.id('ContactButtonCityOffice29e3b63d09d1f0c9a9c7238064c70790'));
    }

    get ContactButtonCityOfficeWest() {
        return element(by.id('ContactButtonCityOfficeb4b178107cbc0c609d8d190bbdbdfb08'));
    }

    get ContactButtonCityOfficeZuid() {
        return element(by.id('ContactButtonCityOfficeb887a4d081821c4245c02f07e2de3290'));
    }

    get ContactButtonCityOfficeZO() {
        return element(by.id('ContactButtonCityOfficed338d28f8e6132ea2cfcf3e61785454c'));
    }

    get ContactButtonCityOfficeWeesp() {
        return element(by.id('ContactButtonCityOffice5ae1d0dd98a417fbf6772aeec85cb40f'));
    }
