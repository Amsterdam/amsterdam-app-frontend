...
- `CHAT_DEVELOPER_NAME_[ENV]`: developer name to be included in the Salesforce core config in the chat module
- `CHAT_ORGANIZATION_ID_[ENV]`: organization id to be included in the Salesforce core config in the chat module
- `CHAT_URL_[ENV]`: chat url to be included in the Salesforce core config in the chat module
