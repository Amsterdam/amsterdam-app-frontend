import type {SurveyRetrieveApiResponse, Survey} from '@/modules/survey/types'
import {ModuleSlug} from '@/modules/slugs'
import {baseApi} from '@/services/baseApi'

export const surveyService = baseApi.injectEndpoints({
  endpoints: builder => ({
    surveys: builder.query<SurveyRetrieveApiResponse, void>({
      query: () => ({
    ...
    latestSurvey: builder.query<Survey, string>({
      query: unique_code => ({
        slug: ModuleSlug.survey,
