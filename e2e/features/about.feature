Feature: Over deze app
  ...
  Given ik ben op de over deze app pagina
  ...
  Then ik zie een pagina met uitleg over de app
  
  @excluded
  Scenario: About this app
  Given ik ben op de over deze app pagina
  When ik klik op 'About this app'
  Then ik zie een pagina met uitleg over deze app in het Engels

  @excluded
  Scenario: Privacyverklaring
  Given ik ben op de over deze app pagina
  When ik klik op 'Privacyverklaring'
  Then ik zie een pagina met de Privacyverklaring

  @excluded
  Scenario: Toegankelijkheidsverklaring
  Given ik ben op de over deze app pagina
  When ik klik op 'Toegankelijkheidsverklaring'
  Then ik zie een pagina met de Toegankelijkheidsverklaring
