...
import {REDIRECTS_EXTERNAL_LINKS} from '@/modules/redirects/constants'
...
export const SelectCityScreen = ({navigation}: Props) => {
  ...
  const {MAKE_APPOINTMENT_WEESP_URL} = REDIRECTS_EXTERNAL_LINKS
              ...
              <Row gutter="md">
                ...
                <Column flex={1}>
                  <Button
                    ...
                    label="Weesp"
                    onPress={() => openWebUrl(MAKE_APPOINTMENT_WEESP_URL)}
                  />
                </Column>
              </Row>
            </Column>
