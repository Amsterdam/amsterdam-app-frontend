      ...
      <Box>
        <Column gutter="xl">
          ...
          <Column gutter="sm">
            ...
            <Paragraph>
              De gemeente werkt vaak aan de straten, bruggen, kades of gebouwen.
              In 'Werkzaaamheden’ ziet u de projecten bij u in de buurt. U kunt
              een project volgen in de app. Als u een project volgt, dan bent u
              altijd op de hoogte van de werkzaamheden.
            </Paragraph>
          </Column>
          <Column gutter="sm">
            ...
            <Paragraph>
              Is de container voor afval vol? Doet de lantaarnpaal het niet? Of
              ligt er troep op straat? Dat kunt u allemaal melden met de app. We
              lossen het probleem zo snel mogelijk voor u op.
            </Paragraph>
          </Column>
          <Image
            source={require('@/modules/about/assets/people-in-park.jpeg')}
          />
          <Column gutter="sm">
            <Title
              level="h2"
